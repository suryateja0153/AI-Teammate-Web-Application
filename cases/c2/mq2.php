        ...
        <div class="row" style="height:90vh;background-color:white">
            ...
            <div class="column" style="width: 46%;border:solid #CFC493 3px;border-top:0px !important; height: 150vh;background-color:white; border-bottom-left-radius:10px">
                <div id="chatDiv" style="height:80vh;overflow:auto">
        					...
        					<div id="a1" <p> <span class="tab-1"></span>&nbsp; &nbsp;  I will also answer along with you..</p></div><br>
        					<div id="a2" <p><span class="tab-1"></span>&nbsp; &nbsp; <span id="reply"></span></p></div><br>
                </div>
            </div>
        </div>
    </div>
    ...
    function passvalues()
    {
                    $.ajax({
                        ...
                        success: function (response) {
                                window.location.replace(window.location.href.replace('mq2', 'bs2'))
                        },
                        error: function (response) {
                                window.location = 'mq2.php';
                        }
                    });
    }
</script>
