<?php
    ...
    $_SESSION['scs1'] = mysqli_real_escape_string($conn, $_POST['scs1']);
    $_SESSION['scs2'] = mysqli_real_escape_string($conn, $_POST['scs2']);
    $_SESSION['scs3'] = mysqli_real_escape_string($conn, $_POST['scs3']);
