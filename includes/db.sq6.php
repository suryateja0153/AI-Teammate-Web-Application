<?php
    ...
    $_SESSION['pmv1'] = mysqli_real_escape_string($conn, $_POST['pmv1']);
    $_SESSION['pmv2'] = mysqli_real_escape_string($conn, $_POST['pmv2']);
    $_SESSION['pmv3'] = mysqli_real_escape_string($conn, $_POST['pmv3']);
    $_SESSION['pmv4'] = mysqli_real_escape_string($conn, $_POST['pmv4']);

    $_SESSION['pfv1'] = mysqli_real_escape_string($conn, $_POST['pfv1']);
    $_SESSION['pfv2'] = mysqli_real_escape_string($conn, $_POST['pfv2']);
    $_SESSION['pfv3'] = mysqli_real_escape_string($conn, $_POST['pfv3']);
    $_SESSION['pfv4'] = mysqli_real_escape_string($conn, $_POST['pfv4']);

    $_SESSION['cap1'] = mysqli_real_escape_string($conn, $_POST['cap1']);
    $_SESSION['cap2'] = mysqli_real_escape_string($conn, $_POST['cap2']);
    $_SESSION['cap3'] = mysqli_real_escape_string($conn, $_POST['cap3']);
    $_SESSION['cap4'] = mysqli_real_escape_string($conn, $_POST['cap4']);
