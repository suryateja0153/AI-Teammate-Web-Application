<?php
  ...
  // if (isset($_POST['submit'])) {
    ...
    $_SESSION['atwwa1'] = mysqli_real_escape_string($conn, $_POST['atwwa1']);
    $_SESSION['atwwa2'] = mysqli_real_escape_string($conn, $_POST['atwwa2']);
    $_SESSION['atwwa3'] = mysqli_real_escape_string($conn, $_POST['atwwa3']);

    $_SESSION['anthro1'] = mysqli_real_escape_string($conn, $_POST['anthro1']);
    $_SESSION['anthro2'] = mysqli_real_escape_string($conn, $_POST['anthro2']);
    $_SESSION['anthro3'] = mysqli_real_escape_string($conn, $_POST['anthro3']);
    $_SESSION['anthro4'] = mysqli_real_escape_string($conn, $_POST['anthro4']);
