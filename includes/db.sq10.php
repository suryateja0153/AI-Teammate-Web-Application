<?php
    ...
    $_SESSION['ap1'] = mysqli_real_escape_string($conn, $_POST['ap1']);
    $_SESSION['ap2'] = mysqli_real_escape_string($conn, $_POST['ap2']);
    $_SESSION['ap3'] = mysqli_real_escape_string($conn, $_POST['ap3']);
