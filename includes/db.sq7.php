<?php
    ...
    $_SESSION['sco1'] = mysqli_real_escape_string($conn, $_POST['sco1']);
    $_SESSION['sco2'] = mysqli_real_escape_string($conn, $_POST['sco2']);
    $_SESSION['sco3'] = mysqli_real_escape_string($conn, $_POST['sco3']);
    $_SESSION['sco4'] = mysqli_real_escape_string($conn, $_POST['sco4']);

    $_SESSION['sco5'] = mysqli_real_escape_string($conn, $_POST['sco5']);
    $_SESSION['sco6'] = mysqli_real_escape_string($conn, $_POST['sco6']);
    $_SESSION['sco7'] = mysqli_real_escape_string($conn, $_POST['sco7']);
    $_SESSION['sco8'] = mysqli_real_escape_string($conn, $_POST['sco8']);

    $_SESSION['sco9'] = mysqli_real_escape_string($conn, $_POST['sco9']);
    $_SESSION['sco10'] = mysqli_real_escape_string($conn, $_POST['sco10']);
    $_SESSION['sco11'] = mysqli_real_escape_string($conn, $_POST['sco11']);
