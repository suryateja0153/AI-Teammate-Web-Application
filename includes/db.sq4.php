<?php
    ...
    $_SESSION['st1'] = mysqli_real_escape_string($conn, $_POST['st1']);
    $_SESSION['st2'] = mysqli_real_escape_string($conn, $_POST['st2']);
    $_SESSION['st3'] = mysqli_real_escape_string($conn, $_POST['st3']);
    $_SESSION['st4'] = mysqli_real_escape_string($conn, $_POST['st4']);
