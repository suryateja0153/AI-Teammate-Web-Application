<?php
  ...
  // if (isset($_POST['submit'])) {
    ...
    $_SESSION['so1'] = mysqli_real_escape_string($conn, $_POST['so1']);
    $_SESSION['so2'] = mysqli_real_escape_string($conn, $_POST['so2']);
    $_SESSION['so3'] = mysqli_real_escape_string($conn, $_POST['so3']);
    $_SESSION['so4'] = mysqli_real_escape_string($conn, $_POST['so4']);
