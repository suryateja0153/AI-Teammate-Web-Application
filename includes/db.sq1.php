<?php
    ...
    $_SESSION['iat1'] = mysqli_real_escape_string($conn, $_POST['iat1']);
    $_SESSION['iat2'] = mysqli_real_escape_string($conn, $_POST['iat2']);
    $_SESSION['iat3'] = mysqli_real_escape_string($conn, $_POST['iat3']);
